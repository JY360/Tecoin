...
bool AppInit(int argc, char* argv[])
{
    ...
    try
    {
        ...
        // Parameters
        //
        // If Qt is used, parameters/tecoin.conf are parsed in qt/bitcoin.cpp's main()
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("Tecoin version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  tecoind [options]                     " + "\n" +
                  "  tecoind [options] <command> [params]  " + _("Send command to -server or tecoind") + "\n" +
                  "  tecoind [options] help                " + _("List commands") + "\n" +
                  "  tecoind [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "tecoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -?                     " + _("This help message") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: tecoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: tecoind.pid)") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 9846 or testnet: 19846)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 9846 or testnet: 19846)") + "\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (fDaemon)
        fprintf(stdout, "Tecoin server starting\n");
