...
{
    ui->labelCurrentReward->setText(QString::number(current) + " TEC");
    if (count > 0)
        ui->labelNextReward->setText(QString::number(next) +" TEC");
    else
    ...
    ui->labelYourVote->setText(QString::number(vote) + " TEC");
    ...
    if (phase == 1) {
        ...
        ui->labelTarget->setText(QString::number(target) + " TEC");
    }
    else if (phase == 2) {
    ...
    ui->labelCurrentSupply->setText(QString::number(supply) + " TEC");
    ui->labelMaxSupply->setText(QString::number(max) + " TEC");
